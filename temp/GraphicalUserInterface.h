...
private: System::Void equals_Click(System::Object^  sender, System::EventArgs^  e)
{
	...
	System::String^ managed = this->display->Text;//Input.
	std::string unmanaged = msclr::interop::marshal_as<std::string>(managed);
	unmanaged = RPNCalculation1.rpnEvaluate(ShuntingYard1.infixToPostfix(unmanaged));
	//System::String^ managed = “”;
	managed = msclr::interop::marshal_as<System::String^>(unmanaged);
	this->display->Text = managed;
