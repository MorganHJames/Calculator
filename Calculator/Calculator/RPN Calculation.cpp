...
double RPNCalculation::rpnEvaluate(const std::string &a_c_sPostfix)//A function that takes in a string as an argument that should be a postfix equation and returns a double that is the answer.
{
	//Current operations: +, -, *, /, ^.
